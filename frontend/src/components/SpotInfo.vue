<template>
  <div class="info-wrapper" v-if="isVisible">
    ...
    <div class="info-box">
      ...
      <div class="actions">
        <CQButton v-if="isInRange" b-style="puzzle-piece" :status="isDiscovered ? 'inactive' : 'active'">
        ...
        <p v-else class="info">{{
            isDiscovered ? "Besuche diesen Ort erneut, um einen Sammelbucheintrag zu erstellen." :
